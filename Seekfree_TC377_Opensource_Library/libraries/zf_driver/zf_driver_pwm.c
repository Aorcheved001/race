...
static IfxGtm_Atom_ToutMap* get_pwm_pin (pwm_channel_enum atom_pin)
{
    ...
    switch(atom_pin)
    {
        ...
        case ATOM4_CH2_P21_4: pwm_pwm_pin_config = &IfxGtm_ATOM4_2_TOUT55_P21_4_OUT;    break;
        case ATOM4_CH3_P21_5: pwm_pwm_pin_config = &IfxGtm_ATOM4_3_TOUT56_P21_5_OUT;    break;
...
void pwm_set_duty (pwm_channel_enum pwmch, uint32 duty)
{
    ...
    switch(atom_channel->atom)
    {
        ...
        case 4: duty = (uint32)((uint64)duty * period / PWM_DUTY_MAX); break;
        default:break;
    }
...
void pwm_init (pwm_channel_enum pwmch, uint32 freq, uint32 duty)
{
    ...
    switch(atom_channel->atom)
    {
        ...
        case 4: IFX_ASSERT(IFX_VERBOSE_LEVEL_ERROR, duty <= PWM_DUTY_MAX); break;
        default:break;
    }
    ...
    switch(atom_channel->atom)
    {
        ...
        case 4: g_atomConfig.dutyCycle = (uint32)((uint64)duty * g_atomConfig.period / PWM_DUTY_MAX); break;
        default:break;
    }
