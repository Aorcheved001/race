...
code/control/PID_cmd.src \
code/control/VOFA.src \
...
code/control/PID.o: code/control/PID.src code/control/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
code/control/PID_cmd.src: ../code/control/PID_cmd.c code/control/subdir.mk
	cctc -cs --dep-file="$(*F).d" --misrac-version=2004 -D__CPU__=tc37x "-fC:/Users/A/AURIX-v1.10.2-workspace/new_ins_local/Debug/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc37x -Y0 -N0 -Z0 -o "$@" "$<"
code/control/PID_cmd.o: code/control/PID_cmd.src code/control/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
code/control/VOFA.src: ../code/control/VOFA.c code/control/subdir.mk
	cctc -cs --dep-file="$(*F).d" --misrac-version=2004 -D__CPU__=tc37x "-fC:/Users/A/AURIX-v1.10.2-workspace/new_ins_local/Debug/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc37x -Y0 -N0 -Z0 -o "$@" "$<"
code/control/VOFA.o: code/control/VOFA.src code/control/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
...
clean-code-2f-control:
	-$(RM) code/control/Motor.d code/control/Motor.o code/control/Motor.src code/control/PID.d code/control/PID.o code/control/PID.src code/control/PID_cmd.d code/control/PID_cmd.o code/control/PID_cmd.src code/control/VOFA.d code/control/VOFA.o code/control/VOFA.src code/control/encoder.d code/control/encoder.o code/control/encoder.src code/control/ins_new_264.d code/control/ins_new_264.o code/control/ins_new_264.src code/control/steering_control.d code/control/steering_control.o code/control/steering_control.src code/control/track.d code/control/track.o code/control/track.src code/control/yaokong.d code/control/yaokong.o code/control/yaokong.src code/control/zf_device_lora3a22.d code/control/zf_device_lora3a22.o code/control/zf_device_lora3a22.src
