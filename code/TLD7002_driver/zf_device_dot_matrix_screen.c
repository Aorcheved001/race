...
const uint8 tld7002_light_font_5x7[][7] =
{
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},  //    0
        { 0x08, 0x08, 0x08, 0x08, 0x00, 0x08, 0x00},  // !  1
        { 0x14, 0x14, 0x14, 0x00, 0x00, 0x00, 0x00},  // "  2
        ...
        { 0x0C, 0x08, 0x04, 0x00, 0x00, 0x00, 0x00},  // '  7
        { 0x10, 0x08, 0x04, 0x04, 0x04, 0x08, 0x10},  // (  8
        { 0x1C, 0x22, 0x22, 0x3C, 0x20, 0x10, 0x0C},  // )  9
        { 0x00, 0x08, 0x2A, 0x1C, 0x2A, 0x08, 0x00},  // * 10
        { 0x00, 0x08, 0x08, 0x3E, 0x08, 0x08, 0x00},  // + 11
        { 0x00, 0x00, 0x00, 0x00, 0x18, 0x10, 0x08},  // , 12
        { 0x00, 0x00, 0x00, 0x3E, 0x00, 0x00, 0x00},  // - 13
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x0C},  // . 14
        { 0x00, 0x20, 0x10, 0x08, 0x04, 0x02, 0x01},  // / 15
        { 0x02, 0x06, 0x0E, 0x1E, 0x0E, 0x06, 0x02},  // 0 16
        { 0x20, 0x30, 0x38, 0x3C, 0x38, 0x30, 0x20},  // 1 17
        { 0x00, 0x00, 0x08, 0x08, 0x08, 0x00, 0x00},  // 2 18
        { 0x00, 0x00, 0x3E, 0x3E, 0x3E, 0x00, 0x00},  // 3 19
        { 0x00, 0x00, 0x1E, 0x1E, 0x1E, 0x00, 0x00},  // 4 20
        { 0x00, 0x00, 0x3C, 0x3C, 0x3C, 0x00, 0x00},  // 5 21
        { 0x20, 0x10, 0x08, 0x08, 0x08, 0x10, 0x20},  // 6 22
        { 0x1E, 0x10, 0x10, 0x10, 0x10, 0x10, 0x1E},  // 7 23
        { 0x02, 0x04, 0x0A, 0x04, 0x0A, 0x04, 0x08},  // 8 24
        { 0x00, 0x0E, 0x00, 0x0E, 0x00, 0x0E, 0x00},  // 9 25
        { 0x00, 0x0C, 0x0C, 0x00, 0x0C, 0x0C, 0x00},  // : 26
        { 0x00, 0x0C, 0x0C, 0x00, 0x0C, 0x08, 0x04},  // ; 27
        { 0x10, 0x08, 0x04, 0x02, 0x04, 0x08, 0x10},  // < 28
        { 0x00, 0x00, 0x3E, 0x00, 0x3E, 0x00, 0x00},  // = 29
        ...
        { 0x1C, 0x22, 0x20, 0x10, 0x08, 0x00, 0x08},  // ? 31
        { 0x1C, 0x22, 0x20, 0x2C, 0x3A, 0x22, 0x1C},  // @ 32
        { 0x04, 0x0E, 0x04, 0x0E, 0x04, 0x0E, 0x04},  // A 33
        { 0x1E, 0x22, 0x22, 0x1E, 0x22, 0x22, 0x1E},  // B 34
        { 0x1C, 0x22, 0x02, 0x02, 0x02, 0x22, 0x1C},  // C 35
        { 0x0E, 0x12, 0x22, 0x22, 0x22, 0x12, 0x0E},  // D 36
        { 0x3E, 0x02, 0x02, 0x1E, 0x02, 0x02, 0x3E},  // E 37
...
void light_dot_matrix_screen_scan(void)
{
    ...
    if(0 == (entry_num % 2))
    {
        ...
        if(7 > display_row_now)
        {
            ...
            for(i = 0; 5 > i; i++)
            {
                if((tld7002_light_font_5x7[dot_matrix_screen_data_backup[0] - ' '][display_row_now]) & ((uint16)1 << (i + 1))) // (i + 1)中的+1 是为了去掉取模的第一列空白
                {
                    tld7002_duty[i] = dot_matrix_screen_brightness;
                }
                else
            ...
            for(; 10 > i; i++)
            {
                if((tld7002_light_font_5x7[dot_matrix_screen_data_backup[1] - ' '][display_row_now]) & ((uint16)1 << (i - 5 + 1)))// (i - 5 + 1)中的+1 是为了去掉取模的第一列空白
                {
                    tld7002_duty[i] = dot_matrix_screen_brightness;
                }
                else
            ...
            for(; 15 > i; i++)
            {
                if((tld7002_light_font_5x7[dot_matrix_screen_data_backup[2] - ' '][display_row_now]) & ((uint16)1 << (i - 10 + 1)))// (i - 10 + 1)中的+1 是为了去掉取模的第一列空白
                {
                    tld7002_duty[i] = dot_matrix_screen_brightness;
                }
                else
