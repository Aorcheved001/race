...
#define LORA3A22_UART_INDEX            (UART_5)              // 定义串口遥控器使用的串口
#define LORA3A22_UART_TX_PIN           (UART5_TX_P22_2)      // 遥控器接收机的RX引脚 连接单片机的TX引脚
#define LORA3A22_UART_RX_PIN           (UART5_RX_P22_3)      // 遥控器接收机的TX引脚 连接单片机的RX引脚
