...
{
    interrupt_global_enable(0);                     // 开启中断嵌套
    gnss_uart_callback();                           // GNSS串口接收中断回调
...
IFX_INTERRUPT(uart4_rx_isr, UART4_INT_VECTAB_NUM, UART4_RX_INT_PRIO)
{
    ...
    speech_uart_rx_interrupt_handler();
